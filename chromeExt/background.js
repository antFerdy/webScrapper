...
chrome.runtime.onConnect.addListener(function(port) {
  ...
  port.onMessage.addListener(function(objectInfo) {
    // console.log(objectInfo);
    // sendRequest(objectInfo);
...
function sendRequest(objectInfo) {
  ...
  xhttp.open("POST", "http://localhost:8080/screen", true);
  xhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded')
  xhttp.send("element=" + encodeURIComponent(objectInfo.element) + "&path=" + encodeURIComponent(objectInfo.path));
}
